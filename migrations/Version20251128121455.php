 ...
 */
final class Version20251128121455 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE playe_blackjack ADD COLUMN hand VARCHAR(255) DEFAULT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TEMPORARY TABLE __temp__playe_blackjack AS SELECT id, gamepl_id, name, score, dealer FROM playe_blackjack
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            INSERT INTO playe_blackjack (id, gamepl_id, name, score, dealer) SELECT id, gamepl_id, name, score, dealer FROM __temp__playe_blackjack
        SQL);
        $this->addSql(<<<'SQL'
