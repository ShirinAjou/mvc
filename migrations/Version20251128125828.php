 ...
 */
final class Version20251128125828 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ...
            , CONSTRAINT FK_4511CEA561305F7C FOREIGN KEY (gamepl_id) REFERENCES game_black_jack (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE playe_blackjack (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, gamepl_id INTEGER NOT NULL, name VARCHAR(255) DEFAULT NULL, score INTEGER DEFAULT NULL, dealer BOOLEAN NOT NULL, cardhand CLOB DEFAULT NULL, hand VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_4511CEA561305F7C FOREIGN KEY (gamepl_id) REFERENCES game_black_jack (id) NOT DEFERRABLE INITIALLY IMMEDIATE)
        SQL);
        $this->addSql(<<<'SQL'
            INSERT INTO playe_blackjack (id, gamepl_id, name, score, dealer, cardhand) SELECT id, gamepl_id, name, score, dealer, cardhand FROM __temp__playe_blackjack
        SQL);
